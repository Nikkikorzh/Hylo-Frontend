        ...
        <section style={{ marginBottom: 40 }}>
          ...
          {!loading && rates && (
            <div style={{
              ...
              <APYCard title="Loopscale xSOL ONE" apy={rates.loopscale_xsOL_one} label="xSOL ONE APY" icon={ICONS.xsol} link="https://app.loopscale.com/vault/xsol_one" color="purple" calcLabel="Loopscale xSOL" rate={rates.loopscale_xsOL_one} onCalc={compute} calcLoading={calcLoading} />
              ...
              <APYCard title="Loopscale hyUSD ONE" apy={rates.loopscale_hyusd_one} label="hyUSD ONE APY" icon={ICONS.hyusd} link="https://app.loopscale.com/vault/hyusd_one" color="green" calcLabel="Loopscale hyUSD" rate={rates.loopscale_hyusd_one} onCalc={compute} calcLoading={calcLoading} />
